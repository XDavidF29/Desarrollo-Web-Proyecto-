...
public class DatabaseInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        // Guardar 50 usuarios
        usuarioRepository.save(new Usuario(null, "Juan", "juan@example.com", 123456789, 111222333, "password1", null));
        usuarioRepository.save(new Usuario(null, "Pedro", "pedro@example.com", 987654321, 444555666, "password2", null));
        usuarioRepository.save(new Usuario(null, "Carlos", "carlos@example.com", 112233445, 222333444, "password3", null));
        usuarioRepository.save(new Usuario(null, "Ana", "ana@example.com", 554433221, 665544332, "password4", null));
        usuarioRepository.save(new Usuario(null, "María", "maria@example.com", 777888999, 888777666, "password5", null));
        usuarioRepository.save(new Usuario(null, "Luis", "luis@example.com", 123123123, 321321321, "password6", null));
        usuarioRepository.save(new Usuario(null, "Sofía", "sofia@example.com", 456456456, 654654654, "password7", null));
        usuarioRepository.save(new Usuario(null, "Miguel", "miguel@example.com", 789789789, 987987987, "password8", null));
        usuarioRepository.save(new Usuario(null, "Raquel", "raquel@example.com", 147258369, 963852741, "password9", null));
        usuarioRepository.save(new Usuario(null, "David", "david@example.com", 258369147, 741852963, "password10", null));
        usuarioRepository.save(new Usuario(null, "Lucía", "lucia@example.com", 369147258, 852963741, "password11", null));
        usuarioRepository.save(new Usuario(null, "Ricardo", "ricardo@example.com", 987123654, 654321987, "password12", null));
        usuarioRepository.save(new Usuario(null, "Elena", "elena@example.com", 654987321, 321789654, "password13", null));
        usuarioRepository.save(new Usuario(null, "José", "jose@example.com", 123654789, 987456321, "password14", null));
        usuarioRepository.save(new Usuario(null, "Carmen", "carmen@example.com", 456789123, 789123456, "password15", null));
        usuarioRepository.save(new Usuario(null, "Francisco", "francisco@example.com", 741963852, 852147963, "password16", null));
        usuarioRepository.save(new Usuario(null, "Isabel", "isabel@example.com", 963741258, 258963147, "password17", null));
        usuarioRepository.save(new Usuario(null, "Jesús", "jesus@example.com", 159753486, 486357159, "password18", null));
        usuarioRepository.save(new Usuario(null, "Verónica", "veronica@example.com", 753159846, 846951753, "password19", null));
        usuarioRepository.save(new Usuario(null, "Gustavo", "gustavo@example.com", 987654321, 123456789, "password20", null));
        usuarioRepository.save(new Usuario(null, "Patricia", "patricia@example.com", 112233445, 554433221, "password21", null));
        usuarioRepository.save(new Usuario(null, "Felipe", "felipe@example.com", 998877665, 332211554, "password22", null));
        usuarioRepository.save(new Usuario(null, "Daniel", "daniel@example.com", 111222333, 444555666, "password23", null));
        usuarioRepository.save(new Usuario(null, "Andrea", "andrea@example.com", 666555444, 333222111, "password24", null));
        usuarioRepository.save(new Usuario(null, "Fernando", "fernando@example.com", 222111333, 666444555, "password25", null));
        usuarioRepository.save(new Usuario(null, "Rosa", "rosa@example.com", 555666777, 444333222, "password26", null));
        usuarioRepository.save(new Usuario(null, "Oscar", "oscar@example.com", 777666555, 222333444, "password27", null));
        usuarioRepository.save(new Usuario(null, "Natalia", "natalia@example.com", 888999000, 99888, "password28", null));
        usuarioRepository.save(new Usuario(null, "Sergio", "sergio@example.com", 333222111, 111222333, "password29", null));
        usuarioRepository.save(new Usuario(null, "Laura", "laura@example.com", 444555666, 666555444, "password30", null));
        usuarioRepository.save(new Usuario(null, "Hugo", "hugo@example.com", 222333444, 555666777, "password31", null));
        usuarioRepository.save(new Usuario(null, "Valeria", "valeria@example.com", 000111222, 333444555, "password32", null));
        usuarioRepository.save(new Usuario(null, "Alejandro", "alejandro@example.com", 555444333, 111000999, "password33", null));
        usuarioRepository.save(new Usuario(null, "Carla", "carla@example.com", 666777888, 222111000, "password34", null));
        usuarioRepository.save(new Usuario(null, "Ramiro", "ramiro@example.com", 111999888, 888777666, "password35", null));
        usuarioRepository.save(new Usuario(null, "Sara", "sara@example.com", 000555444, 333111222, "password36", null));
        usuarioRepository.save(new Usuario(null, "Iván", "ivan@example.com", 444333222, 666000999, "password37", null));
        usuarioRepository.save(new Usuario(null, "Paula", "paula@example.com", 333666555, 444222111, "password38", null));
        usuarioRepository.save(new Usuario(null, "Javier", "javier@example.com", 555999666, 777000111, "password39", null));
        usuarioRepository.save(new Usuario(null, "Ángela", "angela@example.com", 777333111, 888222000, "password40", null));
        usuarioRepository.save(new Usuario(null, "Mauricio", "mauricio@example.com", 999888777, 000111333, "password41", null));
        usuarioRepository.save(new Usuario(null, "Liliana", "liliana@example.com", 111222333, 444555666, "password42", null));
        usuarioRepository.save(new Usuario(null, "Rodrigo", "rodrigo@example.com", 222333444, 555666777, "password43", null));
        usuarioRepository.save(new Usuario(null, "Camila", "camila@example.com", 33344555, 666777888, "password44", null));
        usuarioRepository.save(new Usuario(null, "Matías", "matias@example.com", 444555666, 777888999, "password45", null));
        usuarioRepository.save(new Usuario(null, "Elisa", "elisa@example.com", 555666777, 888999000, "password46", null));
        usuarioRepository.save(new Usuario(null, "Pablo", "pablo@example.com", 666777888, 999000111, "password47", null));
        usuarioRepository.save(new Usuario(null, "Adriana", "adriana@example.com", 777888999, 111222333, "password48", null));
        usuarioRepository.save(new Usuario(null, "Tomás", "tomas@example.com", 888999000, 222333444, "password49", null));
        usuarioRepository.save(new Usuario(null, "Olga", "olga@example.com", 999000111, 333444555, "password50", null));
